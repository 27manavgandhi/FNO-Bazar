...
import style from "./OptionChainBelowTable.module.css";

function OptionChainBelowTable(props) {
  ...
  // if (!optionChainData || strikeArray.length <= 0) return <>loading...</>;
...
export default OptionChainBelowTable;
